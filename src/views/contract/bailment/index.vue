    ...
    >
      <el-form ref="form" :model="form" :rules="rules" label-width="auto">
        <el-row :gutter="30">
          ...
          <el-col :span="12">
            <el-form-item label="寄存入库时间" prop="inTime">
              <el-date-picker
                clearable
                size="small"
                v-model="form.inTime"
                ...
                style="width: 100%"
                value-format="yyyy-MM-dd"
                placeholder="选择寄存入库时间"
              >
              </el-date-picker>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="寄存出库时间" prop="outTime">
              <el-date-picker
                clearable
                size="small"
        ...
        <el-card v-show="subOpen">
          <el-row :gutter="20">
            ...
            <el-col :span="12">
              <el-form-item label="寄存单位" prop="customerId">
                <el-popover
                  placement="top-start"
                  width="auto"
                  style="height: 200px; overflow: auto"
...
export default {
  ...
  methods: {
    ...
    handleCreate() {
      this.subOpen = true;
      this.form.formCode = "JC-" + new Date().getTime();
    },
    /** 提交按钮 */
    submitForm() {
    ...
    selected(selection, component) {
      switch (component) {
        case "warehouse":
          ...
          break;
        case "lessee":
          this.form.customerName = selection.companyName;
