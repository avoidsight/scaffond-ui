    ...
    >
      <el-form ref="form" :model="form" :rules="rules" label-width="auto">
        <el-row :gutter="30">
          ...
          <el-col :span="12">
            <el-form-item label="入库开始时间" prop="inTime">
              <el-date-picker
                clearable
                size="small"
                v-model="form.inTime"
          ...
          <el-col :span="12">
            <el-form-item label="入库结束时间" prop="outTime">
              <el-date-picker
                clearable
                size="small"
              ...
              <el-form-item label="供货单位" prop="customerId">
                ...
                >
                  <select-list
                    ...
                    @selected="selected"
                    popoverType="manufacturer"
                  />
                  <el-input
                    slot="reference"
                    v-model="form.customerName"
                    placeholder="点击选择生产商名录的单位"
                    readonly
                  >
                  </el-input>
                </el-popover>
    ...
    selected(selection, component) {
      ...
      switch (component) {
        case "warehouse":
          ...
          break;
        // case "operator":
        //   this.form.operator = selection.nickName;
        //   this.form.operator = selection.userName;
        // break;
        // case "template":
        //   this.form.templateName = selection.name;
        //   this.form.templateId = selection.id;
        // break;
        case "manufacturer":
