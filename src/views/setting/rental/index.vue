  ...
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['business:rental:add']"
          >新增
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['business:rental:edit']"
          >修改
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['business:rental:remove']"
          >删除
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['business:rental:export']"
          >导出
        </el-button>
      </el-col>
      <right-toolbar
    ...
    >
      ...
      <el-table-column
        ...
        prop="registerFunds"
      />
      <el-table-column label="自有盘扣(吨)" align="center" prop="selfFrog" />
      <el-table-column label="单位状态" align="center" prop="status">
        <template slot-scope="scope">
          <dict-tag
            :options="dict.type.sys_company_status"
    ...
    >
      <el-form ref="form" :model="form" :rules="rules" label-width="120px">
        ...
        <el-form-item label="自有盘扣(吨)" prop="selfFrog">
          <el-input v-model="form.selfFrog" placeholder="请输入自有盘扣(吨)" />
        </el-form-item>
        <el-form-item label="单位状态" prop="status">
          <el-radio-group v-model="form.status">
            <el-radio
              v-for="dict in dict.type.sys_company_status"
              :key="dict.value"
              :label="dict.value"
              >{{ dict.label }}</el-radio
            >
